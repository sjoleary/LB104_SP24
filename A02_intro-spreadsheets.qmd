...
::: {.callout-tip title="Consider this"}
Discuss whether you think `GoogleSheets` has the same problems or if it is an acceptable format to avoid these issues.
:::
