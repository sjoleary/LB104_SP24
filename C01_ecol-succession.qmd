...
\[Insert your sketch here - don't forget to add a title/caption!\]
...
For this lab we will be collecting **quantitative data.** This means that we will determine presence/absence of microbes in the different milk treatments[^c01_ecol-succession-3]. Follow the procedure below to create slide smear and heat fix the bacteria to identify and record the microbes present in your milk treatment.
