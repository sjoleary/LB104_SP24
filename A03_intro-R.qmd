...
Create a new object called `length_cm` with the length in centimeters.
Then change the value of our object with the length in millimeters to 50.
What do you think the value of `length_cm` will be now?
:::
