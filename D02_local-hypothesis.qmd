...
Let's take a closer look at the three major groups of lichens you will encounter during lab. You will use this document to compile your sketches and formulate a local hypotheses you would like to investigate and submit it as a homework assignment. Make sure you are keeping good notes throughout and that you take the time to go back over and edit them before you submit.
...
\[Delete this line and inset your sketch here\]
...
Last week, we explored large-scale patterns across sites. Take a look at your list and consider what variables might additionally be important at a local scale. Specifically, consider Saint Anselm Campus which contains a range of different microhabitats (you can also refer to the National Land Cover Database classifications) and brainstorm which variables might play an important role in determining the presence/absence or type of lichens found on trees across campus.
...
::: {.callout-tip title="Consider this"}
Together with your lab partner take a look at the sample areas[^d02_local-hypothesis-1] and read over the field sampling protocol to get an overview of the process[^d02_local-hypothesis-2] and the variables that we will be measuring.

Make a note of any component of the field sampling protocol that you are unsure of.

Compare the variables that we will be measuring to the list that you just generated above that you think can play a key role in determining presence/absence, distribution, and type of lichen present on the Saint Anselm campus. If necessary add additional variables to that list.
:::

[^d02_local-hypothesis-1]: Even though you will be completing the survey in one specific area you will be analyzing the data set across all locations. This means you should be noting differences across those locations and considering how you think this might generate differences in lichen distribution.

[^d02_local-hypothesis-2]: We will test out the methods later during lab so you are ready to go next week
...
::: {.callout-tip title="Give it a try"}
Together with your lab partner identify two local research hypotheses that you would like to test based off of the list of variables that you generated. Record your thought process/reasoning and hypothesis in the callout-box below. We have added a scaffold to help you think through this process.
...
-   In 3-5 sentences, describe what you expect the relationship to be and how will you assess this (data visualization, descriptive/inferential statistics):

-   In 3-5 sentences, describe your rationale (explain why you expect to see this relationship):

-   In 2-3 sentences, write out your complete hypothesis (remember, this is a research hypothesis, not a statistical hypothesis):
