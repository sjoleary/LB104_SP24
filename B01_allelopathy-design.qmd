...
You will have made the observation that one of more parts of certain types of plants emit very distinct odors[^06_allelopathy-design-1].

[^06_allelopathy-design-1]: We would describe them as **odoriferous**.
...
## Formulate a hypothesis and predict your expected outcome.
...
Specifically you will be designing a **bioassay**[^06_allelopathy-design-2] to test the allelopathic effects on radish seeds. Bioassays typically have a simple, easily repeatable design as you want to be able to assess your results within a few weeks.

[^06_allelopathy-design-2]: A **bioassay** is an experiment designed to determine the properties and effects of a drug or chemical on the bodies of living organisms by testing it under controlled laboratory conditions.
