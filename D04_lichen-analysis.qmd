...
Two weeks ago, each of you formulated two hypotheses of important abiotic and biotic variables determining presence/absence, distribution, and type of lichen present in local microhabitats and/or what that tells us about their environment. 

This means that each of you will be analyzing different aspects of your data set. As such we will have you working directly in your lab report to analyze your data and describe your results. Before you go today, make sure you can render your report to a word document that will contain all your figures and tables that you will then be able to use to complete your lab report.
...
Remember to describe the different sample locations in your lab report.
...
Let's look at our data and see how some of our explanatory variables vary across campus. We'll start with our categorical variables.
...
#| tbl-cap: "Tree density in each sample location."
#| message: false
#| error: false
#| warning: false
...
We already saw earlier that tree density plays a role in total lichen coverage. Here we see that the pattern of which side of the tree we see differs among our different categories of tree density.
